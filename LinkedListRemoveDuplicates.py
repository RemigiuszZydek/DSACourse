...
class LinkedList:
    ...
    def remove_duplicates(self):
        ...
        This method iterates through linked list and checks each node. If a node value is duplicate, it removes node by changning it's next pointer to next next pointer."""
        current = self.head
